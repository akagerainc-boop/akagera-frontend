...
export const adminAPI = {
  ...
  applications: (kind, status) => adminClient.get(`/admin/applications/${kind}`, { params: { status } }),
  setApplicationStatus: (kind, id, status) => adminClient.patch(`/admin/applications/${kind}/${id}`, { status }),
